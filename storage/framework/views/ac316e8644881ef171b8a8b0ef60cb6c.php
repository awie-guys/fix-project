...
<head>
    ...
    <title><?php echo e($title); ?> - <?php echo e($appName); ?></title>
...
<body>
    <main class="auth-page" data-aos-delay="0">
        ...
        <section class="auth-left" data-aos="fade-right" data-aos-duration="800">
            ...
            <div class="auth-left-center">
                <div class="auth-logo-wrap" data-aos="zoom-in" data-aos-delay="60">
                    <img
                        src="<?php echo e(asset('assets/images/mts.png')); ?>"
        ...
        <section class="auth-right" data-aos="fade-left" data-aos-duration="800">
            <div class="auth-form-card" data-aos="fade-left" data-aos-delay="140">
                ...
                <form action="<?php echo e(url('/login')); ?>" method="POST" class="auth-form" autocomplete="on">
                    <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('assets/js/auth-particles.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\fix-project\resources\views/auth/login.blade.php ENDPATH**/ ?>